...
namespace Codeworx.Rest.UnitTests.Api.Contract
{
    ...
    public interface ISerializeParameterController
    {
        ...
        [RestGet("date/query/explicit")]
        Task<DateTime?> GetDateTimeQueryExplicitParameter([QueryMember] DateTime? parameter);
        ...
        [RestGet("dateoffset/query/explicit")]
        Task<DateTimeOffset?> GetDateTimeOffsetQueryExplicitParameter([QueryMember] DateTimeOffset? parameter);
        ...
        [RestGet("decimal/query/explicit")]
        Task<decimal?> GetDecimalQueryExplicitParameter([QueryMember] decimal? parameter);
        ...
        [RestGet("double/query/explicit")]
        Task<double?> GetDoubleQueryExplicitParameter([QueryMember] double? parameter);
        ...
        [RestGet("float/query/explicit")]
        Task<float?> GetFloatQueryExplicitParameter([QueryMember] float? parameter);
        ...
        [RestGet("guid/list/query/explicit")]
        Task<List<Guid>> GetGuidListQueryExplicitParameter([QueryMember] List<Guid> parameter);
        ...
        [RestGet("guid/query/explicit")]
        Task<Guid?> GetGuidQueryExplicitParameter([QueryMember] Guid? parameter);
        ...
        [RestGet("int/query/explicit")]
        Task<int?> GetIntQueryExplicitParameter([QueryMember] int? parameter);
        ...
        [RestGet("string/query/explicit")]
        Task<string> GetStringQueryExplicitParameter([QueryMember] string parameter);
