...
namespace Codeworx.Rest.Formatters.Newtonsoft
{
    public class NewtonsoftJsonContentFormatter : IContentFormatter
    {
        private readonly JsonSerializerSettings _settings;

        public NewtonsoftJsonContentFormatter(JsonSerializerSettings settings)
        {
            _settings = settings;
        }
